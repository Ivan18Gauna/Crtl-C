...
const {allProducts, oneProduct, productByGen, productByCategory, productCreate, productEdit, productDelete, productRestore} = require('../controllers/productControllers');
...
router.get('/product/gen/:gen', productByGen)
